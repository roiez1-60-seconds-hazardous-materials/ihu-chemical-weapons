...
const terms: { term: string; cat: Cat; he: string; en: string }[] = [
  ...
  { term: 'PBA', cat: 'tech', he: 'חומרים מבוססי תרופות — סוכנים פרמצבטיים שהוסבו לשימוש נשקי.', en: 'Pharmaceutical-Based Agents — pharmaceutical agents weaponized for military use.' },
  { term: 'CNS', cat: 'tech', he: 'מערכת העצבים המרכזית — המטרה העיקרית של PBAs.', en: 'Central Nervous System — primary target of PBAs.' },
  { term: 'AChE', cat: 'tech', he: 'אצטילכולינאסטראז — אנזים שנחסם ע"י סוכני עצב מסורתיים (סארין, VX).', en: 'Acetylcholinesterase — enzyme inhibited by traditional nerve agents (sarin, VX).' },
  ...
  { term: 'קטמין / Ketamine', cat: 'chem', he: 'חומר הרדמה דיסוציאטיבי — סונתז ב-IHU כולל אננטיומר (S) הפעיל.', en: 'Dissociative anesthetic — synthesized at IHU including active (S)-enantiomer.' },
  { term: 'סבופלורן / Sevoflurane', cat: 'chem', he: 'חומר הרדמה שאיפתי — הסינתזה הראשונה באיראן ב-IHU (2015).', en: 'Inhalation anesthetic — first Iranian synthesis at IHU (2015).' },
  { term: 'נוביצ\'וק / Novichok', cat: 'chem', he: 'סדרת סוכני עצב מתקדמים — מחקר וייצור בקנה מידה קטן באיראן.', en: 'Advanced nerve agent series — small-scale research and production in Iran.' },
  { term: 'חוסיין פח\'ראיאן / Fakhraian', cat: 'person', he: 'פרופסור חבר בכימיה ב-IHU, עורך ראשי של כתבי עת ביטחוניים. מוביל המחקר על PBAs ופרקורסורי סוכני עצב.', en: 'Associate Prof. of Chemistry at IHU, editor-in-chief of defense journals. Lead PBA and nerve agent precursor researcher.' },
