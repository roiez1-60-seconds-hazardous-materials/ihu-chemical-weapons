...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'hero.classified': { he: '[ מסמך מודיעיני ]', en: '[ DECLASSIFIED INTELLIGENCE BRIEFING ]' },
  ...
  'summary.p1': { he: 'איראן פיתחה וחימשה סוכנים כימיים מבוססי-תרופות (PBAs) באמצעות תוכנית מחקר בת שני עשורים שמרכזה באוניברסיטת אימאם חוסיין (IHU) של משמרות המהפכה.', en: 'Iran has developed and weaponized pharmaceutical-based agents (PBAs) through a two-decade research program centered at Imam Hossein University (IHU), the IRGC\'s sole academic institution.' },
  ...
  'chain.subtitle': { he: 'מסינתזה לשדה הקרב', en: 'From Synthesis to the Battlefield' },
  ...
  'hazmat.title': { he: 'השלכות מבצעיות לתגובת חומ"ס', en: 'Operational Implications for HazMat Response' },
